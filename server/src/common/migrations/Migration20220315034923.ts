...
export class Migration20220315034923 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "users" ("id" serial primary key, "username" varchar(255) not null, "avatar_url" varchar(255) null, "is_online" boolean not null default false, "last_login_at" timestamptz(0) null, "password" varchar(255) not null);');

    this.addSql('create table "conversations" ("id" serial primary key, "title" varchar(255) null, "type" text check ("type" in (\'private\', \'group\')) not null, "admin_id" int null, "invite_link_token" varchar(255) null, "last_message_id" int null, "created_at" timestamptz(0) not null default CURRENT_TIMESTAMP);');
    ...
    this.addSql('create table "messages" ("id" serial primary key, "creator_id" int not null, "conversation_id" int not null, "text" varchar(255) null, "images" jsonb null, "is_deleted" boolean not null default false, "created_at" timestamptz(0) not null default CURRENT_TIMESTAMP);');
