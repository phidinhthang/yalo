...
const variantClassnames = {
  primary:
    'text-white bg-blue-700 focus:ring-4 focus:ring-blue-300 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
  secondary:
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const cn = `hover:bg-blue-800 font-medium rounded-lg inline-flex items-center justify-center ${
